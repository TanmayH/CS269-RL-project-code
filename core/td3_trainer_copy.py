...
#         feature_size = self.conv3(self.conv2(self.conv1(torch.zeros(1, *state_dim)))).view(1, -1).size(1)
...
#         a = F.relu(self.conv1(state/255.0))
...
#         self.conv1 = nn.Conv2d(state_dim[0]+action_dim[0], 32, kernel_size=8, stride=4)
#         self.conv2 = nn.Conv2d(32, 64, kernel_size=4, stride=2)
#         self.conv3 = nn.Conv2d(64, 32, kernel_size=3, stride=1)
...
class TD3Actor(nn.Module):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        # self.l2_extra = nn.Linear(256, 256)
